...
-- 2. Create a Subject
INSERT INTO Subjects (userId, nameSubject, academicYear, color) 
VALUES (1, 'Data Access', '2025-2026', '#2196F3');

-- 3. Create a Task for that Subject
INSERT INTO Tasks (subjectId, title, descriptionTask, dueDate, priority) 
...
-- 5. Create an Exam
INSERT INTO Exams (subjectId, nameExam, examType, examDate, classroom) 
